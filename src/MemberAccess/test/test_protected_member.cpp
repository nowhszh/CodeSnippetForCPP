...
int main()
{
    ...
    constexpr Result run_result {
        ...
        .isPub  = IS_PUBLIC_MEMBER(TestStruct, protectedMember),
        .isProt = IS_PROTECTED_MEMBER(TestStruct, protectedMember),
        .isPri  = IS_PRIVATE_MEMBER(TestStruct, protectedMember),
        .level  = MEMBER_ACCESS_LEVEL(TestStruct, protectedMember),
    };
